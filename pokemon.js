...
function clearResults() {
    ...
    audioPokemon.setAttribute("src", ""); // Limpiamos el audio al inicio
}
...
form.addEventListener("submit", (event) => {
    ...
    fetch(`https://pokeapi.co/api/v2/pokemon/${pokemonName}`)
        ...
        .then((pokemon) => {
            ...
            // Actualizar el sonido del Pokémon
            audioPokemon.setAttribute("src", `https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/${pokemon.id}.ogg`);
